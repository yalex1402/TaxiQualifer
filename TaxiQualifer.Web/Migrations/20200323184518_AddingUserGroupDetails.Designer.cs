...
namespace TaxiQualifer.Web.Migrations
{
    ...
    [Migration("20200323184518_AddingUserGroupDetails")]
    partial class AddingUserGroupDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxiQualifer.Web.Data.Entities.UserGroupDetailEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TaxiQualifer.Web.Data.Entities.UserGroupRequestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TaxiQualifer.Web.Data.Entities.UserGroupDetailEntity", b =>
                {
                    b.HasOne("TaxiQualifer.Web.Data.Entities.UserGroupEntity", "UserGroup")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("TaxiQualifer.Web.Data.Entities.UserGroupRequestEntity", b =>
                {
                    b.HasOne("TaxiQualifer.Web.Data.Entities.UserEntity", "ProposalUser")
                        .WithMany()
                        .HasForeignKey("ProposalUserId");

                    b.HasOne("TaxiQualifer.Web.Data.Entities.UserEntity", "RequiredUser")
                        .WithMany()
